...
function Hero() {
  ...
  return (
    <Slider {...settings}>
      ...
      <div
        className={`bg-cover mt-[5%] bg-no-repeat bg-[url('https://educationnewshub.co.ke/wp-content/uploads/2020/05/FB_IMG_15893079055596857-300x300.jpg')]  h-[60vh] flex items-center flex-col text-center justify-center w-screen`}
      >
        <div className="bg-[rgba(0,0,0,.5)] flex text-white justify-center flex-col items-center w-full h-full">
          <h1 className="font-semibold lg:text-5xl md:text-3xl text-xl tracking-widest">
            Maich
