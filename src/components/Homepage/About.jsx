...
function About() {
  return (
    <div className="w-screen bg-[#b08b8d] justify-center items-center px-4 md:px-12 lg:px-20">
      ...
      <div className="flex items-center md:flex-row flex-col gap-4 md:justify-between md:py-12 py-5">
        <div className="bg-[#590000]/30 flex-col gap-3 rounded-md justify-center items-center flex w-[95%] md:w-[350px] max-w-[350px] shadow-md md:shadow-lg p-5 md:p-8 border-[1px] border-[#590000]/80">
