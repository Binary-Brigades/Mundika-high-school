  ...
  return (
    <div className="w-screen px-4 md:px-12 lg:px-20 mt-10">
      <p className="md:text-lg">
        ...
        transparency, accountability, and serving the best interests of our
        students, staff, and community.
        <br />
        <span className="text-lg font-bold mt-8">About Us</span> <br />
        Learn more about the Board of Management, including our mission, vision,
