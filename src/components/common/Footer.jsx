...
function Footer() {
  return (
    <div class="bg-[#2c3e9e] text-white sticky bottom-0">
      <footer class="bg-[#2c3e9e] text-white py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h5 class="text-xl font-semibold mb-6">Contact Us</h5>
              <ul class="space-y-4">
            ...
            <div>
              <h5 class="text-xl font-semibold mb-6">Partner Links</h5>
              <ul class="space-y-4">
                <li>
                  <a href="#" class="hover:underline" rel="ugc">
                    mmust.ac.ke
                  </a>
                </li>
                <li>
        ...
        <a href="#" class="fixed bottom-8 right-8" rel="ugc">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
