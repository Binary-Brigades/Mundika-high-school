  ...
  return (
    <div>
      ...
      <div className="flex mt-5 flex-col md:flex-row justify-between gap-4 px-4 md:px12 lg:px-20">
        <div className="">
          <h5 className="text-xl font-bold mb-1 text-center w-full">
            The Library
          </h5>
          <p>
          ...
          <p>
            Empowering students to become lifelong learners and critical
            thinkers by providing access to diverse resources, fostering a
            culture of inquiry, and promoting a love of reading and exploration.
          </p>

          <h4 className="text-1xl font-bold mb-1 mt-8">
            <a
              href="http://koha.mmust.ac.ke:2048/login"
              className="text-blue-500 underline hover:text-blue-700"
            >
              Here’s
            </a>{" "}
            a link to our E-Library! <br />
        ...
        <div>
          ...
          <p>
            Our mission is to cultivate an inclusive and dynamic learning
            environment where every student can thrive academically,
            intellectually, and personally. Through our comprehensive
            collection, innovative programs, and collaborative partnerships, we
            aim to inspire curiosity, instill a passion for learning, and equip
            students with the skills and knowledge needed to succeed in an
            ever-changing world
          </p>
        </div>
      </div>
