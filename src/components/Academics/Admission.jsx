...
function Admission() {
  ...
  <div className="paragraph">At Mundika High School, we strive to make the admissions process as smooth and transparent as possible. We welcome prospective students and their families to explore the opportunities available at our institution. Below you will find information regarding admission requirements, application procedures, and important dates.
    ...
    <p>To be considered for admission into Form 1 (or equivalent), applicants must meet the following requirements:</p>
    ...
    <div className="ls">
      <ul className="list-disc pl-4">
        ...
        <li>Any additional documents or requirements as specified by the school.</li>
      </ul>
    </div>
    <div className="lp">
    ...
    <div className="lt">
      <ol className="list-decimal pl-4">
        ...
        <li>Complete the Application Form: Download the application form from our website or obtain a hard copy from the school's admissions office. Fill out all required fields accurately and completely.</li>
        <li>Gather Required Documents: Collect all necessary documents, including academic records, birth certificate, and any other documents specified in the application form.</li>
        <li>Submit Your Application: Submit your completed application form and supporting documents to the school's admissions office by the specified deadline. Applications can be submitted in person or by mail.</li>
        <li>Admissions Assessment: Applicants may be required to undergo an admissions assessment, which may include written tests, interviews, or other evaluations.</li>
        <li>Notification of Admission: Once the admissions committee has reviewed your application, you will be notified of the admission decision via email or postal mail.</li>
      </ol>
    </div>
    <div className="lr">
...
<p>For inquiries regarding the admissions process or to schedule a campus tour, please contact: 
  Mundika High School [Admissions Office Address] Phone: [Phone Number] Email: [Email Address] We look forward to welcoming you to [School Name] and assisting you throughout the admissions process. 
